...
const CONTROL_ITEM_CLASS_NAMES =
  'relative inline-flex h-10 px-2.5 py-1 justify-center items-center border-l border-gray-200 leading-5 ring-4 ring-inset ring-white hover:cursor-pointer hover:bg-navy-400/20 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-navy-400/20';

...
const MoreFilters = () => {
  ...
  return (
    <div className="relative">
      <button
        className="flex items-center space-x-2 px-2 py-2.5 h-10 border border-gray-200 rounded-md bg-white shadow-sm hover:cursor-pointer focus:border-navy-400 focus:outline-none focus:ring-0"
        type="button"
        {...getReferenceProps({
          ref: reference,
        })}
      >
        <FilterIcon className="block w-5 h-5 text-gray-900" aria-hidden="true" />
        {counter > 0 && (
      ...
      >
        <div className="p-4 bg-white rounded-md shadow-md w-80 ring-1 ring-gray-200">

...
const THEMES = {
  default: {
    base: 'appearance-none block w-full px-3 py-2 border rounded-md shadow-sm text-gray-900 placeholder-gray-500 focus:outline-none text-sm min-h-[2.5rem]',
        ...
        <div className="flex items-center">
          ...
          <input
            className={classnames([THEMES[theme].base], {
              ...
              'border-gray-300 focus:ring-navy-400 focus:border-navy-400':
                theme === 'default' && !error,

...
> {
  ...
  async createScenarioIntervention(
    ...
    // wrap this to a private function
    ...
    switch (dto.type) {
      case SCENARIO_INTERVENTION_TYPE.NEW_MATERIAL:
        ...
        // Mutates the original instance adding the new Sourcing Locations of type created

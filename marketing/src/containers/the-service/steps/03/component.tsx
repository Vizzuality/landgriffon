        ...
        <div className="space-y-10">
          ...
          <ul className="space-y-5 font-light">
            ...
            <li className="relative pl-5 before:absolute before:top-2 before:left-0 before:w-1.5 before:h-1.5 before:bg-black">
              ...
              <p>
                <a href="https://www.mapspam.info/data/" target="_blank" rel="noreferrer noopener">
                  MapSPAM
                </a>
                ,{' '}
                <a href="http://www.earthstat.org/" target="_blank" rel="noreferrer noopener">
                  Earthstat
                </a>
                ,{' '}
                <a
            ...
            <li className="relative pl-5 before:absolute before:top-2 before:left-0 before:w-1.5 before:h-1.5 before:bg-black">
              ...
              <p>
                ...
                ,{' '}
                <a href="https://www.ibat-alliance.org/" target="_blank" rel="noreferrer noopener">
                  IBAT
                </a>
              </p>
            </li>

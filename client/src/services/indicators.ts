...
const indicatorsService = axios.create({
...
indicatorsService.interceptors.response.use(onResponseSuccess, onResponseError);

export const getIndicators = (params) =>
  indicatorsService.get('/', { params }).then(({ data }) => data);

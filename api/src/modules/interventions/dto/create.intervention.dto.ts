...
import { InterventionLocationAddressInputValidator } from 'modules/interventions/dto/custom-validators/address-input.custom.validator';
import { InterventionLocationLatitudeInputValidator } from 'modules/interventions/dto/custom-validators/latitude-input.custom.validator';
import { InterventionLocationLongitudeInputValidator } from 'modules/interventions/dto/custom-validators/longitude-input.custom.validator';
...
export class CreateInterventionDto {
  ...
  @ApiProperty({
    ...
    enum: Object.values(INTERVENTION_TYPE),
    example: INTERVENTION_TYPE.NEW_MATERIAL,
  })
  ...
  @ValidateIf(
    (dto: CreateInterventionDto) => dto.newIndicatorCoefficients !== null,
  )
  ...
  @ValidateIf(
    (dto: CreateInterventionDto) =>
      dto.type === INTERVENTION_TYPE.NEW_MATERIAL ||
      dto.type === INTERVENTION_TYPE.NEW_SUPPLIER,
  )
  @IsNotEmpty({
    message:
  ...
  @ApiPropertyOptional({
    description: `Type of new Supplier Location, is required for Intervention types: ${INTERVENTION_TYPE.NEW_MATERIAL} and ${INTERVENTION_TYPE.NEW_SUPPLIER}`,
  ...
  @ValidateIf(
    (dto: CreateInterventionDto) =>
      dto.type !== INTERVENTION_TYPE.CHANGE_PRODUCTION_EFFICIENCY,
  )
  @IsNotEmpty({
    message:
  ...
  @ApiProperty({
    description: `New Supplier Location country, is required for Intervention types: ${INTERVENTION_TYPE.NEW_MATERIAL}, ${INTERVENTION_TYPE.NEW_SUPPLIER}`,
    type: String,
    example: 'Spain',
  })
  ...
  @ApiProperty({
    description: `New Administrative Region, is required for Intervention types: ${INTERVENTION_TYPE.NEW_MATERIAL}, ${INTERVENTION_TYPE.NEW_SUPPLIER}
  ...
  @ApiPropertyOptional({
    description: `
    New Supplier Location address, is required for Intervention types: ${INTERVENTION_TYPE.NEW_MATERIAL}, ${INTERVENTION_TYPE.NEW_SUPPLIER}
  ...
  @ApiPropertyOptional({
    description: `
    New Supplier Location latitude, is required for Intervention types: ${INTERVENTION_TYPE.NEW_MATERIAL}, ${INTERVENTION_TYPE.NEW_SUPPLIER}
  ...
  @ApiPropertyOptional({
    description: `
    New Supplier Location longitude, is required for Intervention types: ${INTERVENTION_TYPE.NEW_MATERIAL}, ${INTERVENTION_TYPE.NEW_SUPPLIER}
    and New Supplier Locations of types: ${LOCATION_TYPES.POINT_OF_PRODUCTION} and ${LOCATION_TYPES.PRODUCTION_AGGREGATION_POINT} in case no address was provided.
    Address OR coordinates must be provided.
  ...
  @ValidateIf(
    (dto: CreateInterventionDto) => dto.type === INTERVENTION_TYPE.NEW_MATERIAL,
  )
  @IsNotEmpty({
  ...
  @IsUUID()
  @ApiPropertyOptional({
    description: `Id of the New Material, is required if Intervention type is ${INTERVENTION_TYPE.NEW_MATERIAL}`,
    type: String,

    ...
    <Wrapper>
      <div className="xl:px-16 lg:px-10">
        ...
        <div className="flex flex-col items-center justify-between pb-24 space-y-4 lg:space-x-24 lg:flex-row">
          <h4 className="text-5xl font-semibold lg:w-3/5 md:font-normal md:text-6xl lg:text-7xl">
      ...
      <div className="relative flex flex-col px-4 py-8 lg:py-16 xl:w-4/5 md:px-18 xl:self-end bg-lightBlue">
        ...
        <div className="md:grid md:grid-cols-2">
          ...
          <div className="lg:px-10">
            ...
            <ul className="flex flex-col py-6 space-y-6 text-lg lg:py-16 xl:space-y-12 lg:text-5xl font-sans-semibold">
              <li>Vizzuality</li>
              <li>Satelligence</li>
              <li>SEI</li>
            </ul>
            <Link href="https://landgriffon.com">
              <a
                className="text-lg text-black underline lg:text-5xl font-sans-semibold hover:no-underline"
                target="_blank"

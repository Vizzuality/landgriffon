...
- [2. Geocoding cache config](#2-geocoding-cache-config)
- [3. Asynchronous task handling config (message broker)](#3-asynchronous-task-handling-config-message-broker)
...
[node-config](https://www.npmjs.com/package/config) through [this file](https://github.com/Vizzuality/landgriffon/blob/044ea856536a868e68b786d841f6b73f1859d28b/api/config/custom-environment-variables.json)
for the API app.
...
## 3. Asynchronous task handling config (message broker)

...
> {
  ...
  async createScenarioIntervention(
    ...
    // TODO: Hack to not to use the geoCodeSourcingLocation method of GeoCodingAbstractClass, which is implemented by GeoCodingService
    //       as this is being resolved as undefined by NestJS. Same is happening with other services as IndicatorRecordService

    // TODO: This is being left as is as this implementation is required for Science and other members to start testing the values generated by interventions
    //       We should aim to clean it as soon as possible

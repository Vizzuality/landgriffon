...
const CONTROL_ITEM_CLASS_NAMES =
  'relative ring-4 h-10 min-w-[40px] ring-inset ring-white inline-flex px-2.5 justify-center items-center border-l border-gray-200 leading-5 hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-1 hover:bg-gray-100';
const CONTROL_ITEM_DEFAULT_CLASS_NAMES = 'bg-white text-sm text-gray-900';

  ...
  AndItShouldContainAllTheValidationErrorsOfTheFile = (error: any) => {
    const expectedValidationErrors: ImportTaskError[] = [
      ...
      },
      {
        row: 3,
        column: 'hs_2017_code',
        error: 'hs_2017_code must be a string',
        sheet: 'materials',
        type: 'validation-error',
      },
      {
      ...
      },
      {
        row: 3,
        column: 'path_id',
        error: 'path_id must be a string',
        sheet: 'suppliers',
        type: 'validation-error',
      },
      {
      ...
      },
      {
        ...
        error: 'business_unit.path must be a string',
        sheet: 'sourcingData',
        type: 'validation-error',
      },
      {
      ...
      },
      {
        ...
        error: 'location_country_input must be a string',
        sheet: 'sourcingData',
        type: 'validation-error',
      },
      {
      ...
      },
      {
        row: 2,
        column: 'nameCode',
        error: 'nameCode must be longer than or equal to 1 characters',
        sheet: 'indicators',
        type: 'validation-error',
      },
      {
        row: 2,
        column: 'nameCode',
        error: 'nameCode should not be empty',
        sheet: 'indicators',
        type: 'validation-error',
      },
      {
        row: 2,
        column: 'nameCode',
        error: 'nameCode must be a string',
        sheet: 'indicators',
        type: 'validation-error',
      },
      {
        row: 3,
        column: 'status',
        error: 'status must be one of the following values: ',
        sheet: 'indicators',
        type: 'validation-error',
      },
      {

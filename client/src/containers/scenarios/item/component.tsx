...
import { Menu, Popover, RadioGroup, Switch, Transition } from '@headlessui/react';
...
const DROPDOWN_ITEM_ACTIVE_CLASSNAME = 'hover:bg-gray-100 hover:text-gray-900';
                          ...
                          <div className="py-1">
                            <div>
                              <button
                                ...
                                className={classNames(
                                  'text-gray-700',
                                  DROPDOWN_ITEM_ACTIVE_CLASSNAME,
